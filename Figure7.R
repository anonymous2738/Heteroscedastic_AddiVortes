...
### million songs daaset ###
{
  load("C:\\Users\\adam6\\OneDrive\\Documents\\millionsongs_train.Rdata")
  load("C:\\Users\\adam6\\OneDrive\\Documents\\millionsongs_test.Rdata")
...
Original_AddiVortes<-AddiVortes_Algorithm(y,as.matrix(x),YTest = yp,XTest = as.matrix(xp),max_iter = 120,burn_in = 40,m_var = 40, nu=6,q=0.85,k=5,sd=0.8,Omega=3,lambda_rate=25)
